<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="AdminViewFeedback.aspx.cs" Inherits="AdminViewFeedback" %>
        ...
        <div class="title">
            ...
            <table style="width:60%">
             ...
             for (i = 0; i < tab.Rows.Count; i++)
             {
                 row = tab.Rows[i];
                 Response.Write("<tr>");
                 Response.Write("<td class='pad-10' style='width:150px'><a href=DiaplayAFeedback.aspx?fid=" + Int32.Parse(row["fid"].ToString()) + "&too=" + row["too"].ToString() + ">" + row["feedback"].ToString() + "</td></a></td><td>" + row["date"].ToString() + "</td><td class='pad-10'>" + row["time"].ToString() + "</td><td class='pad-10'><a href=DeleteAFeedback.aspx?fid=" + Int32.Parse(row["fid"].ToString()) + ">Delete</td>");
