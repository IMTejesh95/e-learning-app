<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMaster.master" AutoEventWireup="true" CodeFile="SMessage.aspx.cs" Inherits="SMessage" %>
...
<div class="container">
	...
	<div class="logregform two">
        ...
        <div class="feildcont">
            ...
            <asp:TextBox ID="tsubject" runat="server" required="true"></asp:TextBox></div> <br /><br />
