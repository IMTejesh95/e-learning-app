<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMaster.master" AutoEventWireup="true" CodeFile="SInbox.aspx.cs" Inherits="SInbox" %>
        ...
        <div class="title">
            ...
            <table style="width:60%">
             ...
             for (i = 0; i < tab.Rows.Count; i++)
             {
                 row = tab.Rows[i];
                 Response.Write("<tr>");
                 Response.Write("<td class='pad-10'>" + row["fromm"].ToString() + "</td><td class='pad-10' style='width:100px'><a href=DisplaySMessage.aspx?mid=" + Int32.Parse(row["mid"].ToString()) + ">" + row["subject"].ToString() + "</a></td><td class='pad-10'  style='width:150px'>" + row["message"].ToString() + "</td><td class='pad-10'>" + row["date"].ToString() + "</td><td class='pad-10'>" + row["time"].ToString() + "</td><td class='pad-10'><a href=DeleteSMessage.aspx?mid=" + Int32.Parse(row["mid"].ToString()) + ">Delete</td>");
