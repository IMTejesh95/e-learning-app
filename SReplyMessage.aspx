<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMaster.master" AutoEventWireup="true" CodeFile="SReplyMessage.aspx.cs" Inherits="SReplyMessage" %>
...
<div class="container">
	...
	<div class="logregform two">
        ...
        <div class="feildcont">
            ...
            <div>
                 <label>Too </label>
             <asp:TextBox ID="ttoo" runat="server"></asp:TextBox></div> 
            <br /><br />
